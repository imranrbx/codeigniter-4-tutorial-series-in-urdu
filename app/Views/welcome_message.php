...
<header>
    ...
    <div class="menu">
        <ul>
            <li class="logo"><a href="<?= base_url(); ?>" >
                <img class="mb-0" src="<?php echo base_url('images/wplogo.png'); ?>" alt="" width="32" height="32">
            </a>
            </li>
 ...
 <?php if (session()->getFlashData('message')) : ?>
  <h2><?= session()->getFlashData('message') ?></h2>
 <?php else : ?>
...
<div class="further">
    ...
    <section>
        ...
        <p>CodeIgniter is a community-developed open source project, with several
             ...
             >CodeIgniter's forum</a>, or <a href="https://codeigniterchat.slack.com/"
             >chat on Slack</a> !</p>
        ...
        <p>CodeIgniter is a community driven project and accepts contributions
             ...
             <a href="https://codeigniter.com/en/contribute" >
             join us</a> ?</p>
